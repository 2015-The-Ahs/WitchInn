    ...
    public static Ingredient getIngredient(String name) {
        ...
        switch (name){
            case INGREDIENT_TURTLE:
                return new Ingredient(name, loadImage("resources/turtle.PNG"), new Point(30, 10));
                
            case INGREDIENT_TREE:
                return new Ingredient(name, loadImage("resources/tree.PNG"), new Point(60, 10));
                
            case INGREDIENT_CACTUS:
                return new Ingredient(name, loadImage("resources/cactus.PNG"), new Point(40, 10));
